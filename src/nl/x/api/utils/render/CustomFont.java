...
public class CustomFont {
	...
	private void drawChar(Gui gui, char c, int x, int y) {
		...
		drawTexturedModalRect(x, y, xPos[(byte) c - startChar], yPos[(byte) c - startChar], (int) bounds.getWidth(),
	...
	public void drawTexturedModalRect(int x, int y, int u, int v, int width, int height) {
		...
		WorldRenderer var16 = tessellator.getWorldRenderer();
		var16.startDrawingQuads();
		var16.addVertexWithUV((x + 0), (y + height), 0, ((u + 0) * offsetWidth), ((v + height) * offsetHeight));
		var16.addVertexWithUV((x + width), (y + height), 0, ((u + width) * offsetWidth), ((v + height) * offsetHeight));
		var16.addVertexWithUV((x + width), (y + 0), 0, ((u + width) * offsetWidth), ((v + 0) * offsetHeight));
		var16.addVertexWithUV((x + 0), (y + 0), 0, ((u + 0) * offsetWidth), ((v + 0) * offsetHeight));
		tessellator.draw();
	}
}