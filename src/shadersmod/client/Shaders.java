...
public class Shaders {
	...
	private static int getTextureFormatFromString(String par) {
		return par.matches("[ \t]*R8[ \t]*") ? 33321
				: (par.matches("[ \t]*RG8[ \t]*") ? 33323
						: (par.matches("[ \t]*RGB8[ \t]*") ? 32849
								: (par.matches("[ \t]*RGBA8[ \t]*") ? 32856 : (par.matches("[ \t]*R16[ \t]*") ? 33322
										: (par.matches("[ \t]*RG16[ \t]*") ? 33324
												: (par.matches("[ \t]*RGB16[ \t]*") ? 32852
														: (par.matches("[ \t]*RGBA16[ \t]*") ? 32859
																: (par.matches("[ \t]*R32F[ \t]*") ? 33326
																		: (par.matches("[ \t]*RG32F[ \t]*") ? 33328
																				: (par.matches("[ \t]*RGB32F[ \t]*")
																						? 34837
																						: (par.matches(
																								"[ \t]*RGBA32F[ \t]*")
