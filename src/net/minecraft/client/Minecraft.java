...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	private void initStream() {
		try {
			...
			/**
			 * Same protection method used in the 'Client' class but inside of
			 * the 'Minecraft' class to make it tedious to find the methods and
			 * disable them
			 * 
			 * this.fuckme();
			 */
	...
	/**
	 * Protection method that never makes any class to class's not using
	 * javassist
	 * 
	 * @throws Exception
	 */
	...
	private void displayDebugInfo(long elapsedTicksTime) {
		if (this.mcProfiler.profilingEnabled) {
			...
			for (int var21 = 0; var21 < var3.size(); ++var21) {
				...
				this.fontRendererObj.drawStringWithShadow(var23, var8 - var7, var9 + var7 / 2 + var21 * 8 + 20,
						var22.func_76329_a());
