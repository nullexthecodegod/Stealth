...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	private void orientCamera(float partialTicks) {
		...
		if (var2 instanceof EntityLivingBase && ((EntityLivingBase) var2).isPlayerSleeping()) {
			...
			if (!this.mc.gameSettings.debugCamEnable) {
				...
				GlStateManager.rotate(
						var2.prevRotationYaw + (var2.rotationYaw - var2.prevRotationYaw) * partialTicks + 180.0F, 0.0F,
						-1.0F, 0.0F);
				GlStateManager.rotate(
						var2.prevRotationPitch + (var2.rotationPitch - var2.prevRotationPitch) * partialTicks, -1.0F,
						0.0F, 0.0F);
			}
			...
			if (this.mc.gameSettings.debugCamEnable) {
				...
				double var14 = -MathHelper.sin(var12 / 180.0F * (float) Math.PI)
						* MathHelper.cos(var13 / 180.0F * (float) Math.PI) * var28;
				double var16 = MathHelper.cos(var12 / 180.0F * (float) Math.PI)
						* MathHelper.cos(var13 / 180.0F * (float) Math.PI) * var28;
				...
				for (int var20 = 0; var20 < 8; ++var20) {
					...
					MovingObjectPosition var24 = this.mc.theWorld.rayTraceBlocks(
							...
							new Vec3(var4 - var14 + var21 + var23, var6 - var18 + var22, var8 - var16 + var23));
		...
		if (!this.mc.gameSettings.debugCamEnable) {
			GlStateManager.rotate(var2.prevRotationPitch + (var2.rotationPitch - var2.prevRotationPitch) * partialTicks,
					1.0F, 0.0F, 0.0F);
			...
			if (var2 instanceof EntityAnimal) {
				...
				GlStateManager.rotate(
						var281.prevRotationYawHead
								+ (var281.rotationYawHead - var281.prevRotationYawHead) * partialTicks + 180.0F,
						0.0F, 1.0F, 0.0F);
			} else {
				GlStateManager.rotate(
						var2.prevRotationYaw + (var2.rotationYaw - var2.prevRotationYaw) * partialTicks + 180.0F, 0.0F,
	...
	public void renderHand(float partialTicks, int xOffset) {
		if (!this.debugView) {
			...
			if (!Config.isShaders() || !Shaders.isHandRendered) {
				...
				var4 = this.mc.getRenderViewEntity() instanceof EntityLivingBase
	...
	public void renderStreamIndicator(float partialTicks) {
		this.setupOverlayRendering();
		this.mc.ingameGUI
				.renderStreamIndicator(new ScaledResolution(this.mc, this.mc.displayWidth, this.mc.displayHeight));
	}
	...
	private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
		...
		if (isShaders) {
			ShadersRender.setupTerrain(var5, var9, partialTicks, var8, this.frameCount++,
		...
		if (!var5.damagedBlocks.isEmpty()) {
			...
			var5.drawBlockDamageTexture(Tessellator.getInstance(), Tessellator.getInstance().getWorldRenderer(), var9,
					partialTicks);
			GlStateManager.disableBlend();
		}
	...
	private void addRainParticles() {
		...
		if (var1 != 0.0F && Config.isRainSplash()) {
			...
			for (int var14 = 0; var14 < var13; ++var14) {
				BlockPos var15 = var3
						.getPrecipitationHeight(var4.add(this.random.nextInt(var5) - this.random.nextInt(var5), 0,
				...
				if (var15.getY() <= var4.getY() + var5 && var15.getY() >= var4.getY() - var5
						&& var16.canSpawnLightningBolt() && var16.getFloatTemperature(var15) >= 0.15F) {
			...
			if (var12 > 0 && this.random.nextInt(3) < this.rainSoundCounter++) {
				...
				if (var8 > var4.getY() + 1
						&& var3.getPrecipitationHeight(var4).getY() > MathHelper.floor_float(var4.getY())) {
					...
					if (var26.canSpawnLightningBolt() || var26.getEnableSnow()) {
						...
						if (var28 != var29) {
							...
							if (var4.getWorldChunkManager().getTemperatureAtHeight(var32, var27) >= 0.15F) {
								...
								var9.setColorRGBA_F(var39, var39, var39,
								...
								var9.setBrightness(
										(var4.getCombinedLight(new BlockPos(var21, var31, var20), 0) * 3 + 15728880)
												/ 4);
								var9.setColorRGBA_F(var41, var41, var41,
	...
	private void updateFogColor(float partialTicks) {
		...
		if (this.cloudFog) {
			...
			fogYFactor = CustomColors.getUnderwaterColor(this.mc.theWorld, this.mc.getRenderViewEntity().posX,
		...
		if (Reflector.EntityViewRenderEvent_FogColors_Constructor.exists()) {
			Object event1 = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogColors_Constructor,
					new Object[] { this, var3, var211, Float.valueOf(partialTicks), Float.valueOf(this.fogColorRed),
