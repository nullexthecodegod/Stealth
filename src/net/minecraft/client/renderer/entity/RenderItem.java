...
public class RenderItem implements IResourceManagerReloadListener {
		...
		if (entityToRenderFor instanceof EntityPlayer) {
			...
			if (var6 == Items.fishing_rod && var5.fishEntity != null) {
				...
				var7 = (ModelResourceLocation) Reflector.call(var6, Reflector.ForgeItem_getModel,
						new Object[] { stack, var5, Integer.valueOf(var5.getItemInUseCount()) });
			}
	...
	public static void applyVanillaTransform(ItemTransformVec3f transform) {
		if (transform != ItemTransformVec3f.DEFAULT) {
			GlStateManager.translate(transform.translation.x + debugItemOffsetX,
					transform.translation.y + debugItemOffsetY, transform.translation.z + debugItemOffsetZ);
			...
			GlStateManager.scale(transform.scale.x + debugItemScaleX, transform.scale.y + debugItemScaleY,
					transform.scale.z + debugItemScaleZ);
		}
	}
	...
	public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
		if (stack != null) {
			if (stack.stackSize != 1 || text != null) {
				...
				GlStateManager.disableBlend();
				fr.drawStringWithShadow(itemDamaged, xPosition + 19 - 2 - fr.getStringWidth(itemDamaged),
			...
			if (Reflector.ForgeItem_showDurabilityBar.exists()) {
				itemDamaged1 = Reflector.callBoolean(stack.getItem(), Reflector.ForgeItem_showDurabilityBar,
						new Object[] { stack });
			}
			...
			if (itemDamaged1) {
				...
				if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
					double var8 = Reflector.callDouble(stack.getItem(), Reflector.ForgeItem_getDurabilityForDisplay,
							new Object[] { stack });
