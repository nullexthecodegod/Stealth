...
public class Gui {
	...
	public void drawTexturedModalRect(int xCoord, int yCoord, TextureAtlasSprite textureSprite, int widthIn,
		...
		var7.addVertexWithUV(xCoord + 0, yCoord + heightIn, this.zLevel, textureSprite.getMinU(),
				textureSprite.getMaxV());
		var7.addVertexWithUV(xCoord + widthIn, yCoord + heightIn, this.zLevel, textureSprite.getMaxU(),
				textureSprite.getMaxV());
		var7.addVertexWithUV(xCoord + widthIn, yCoord + 0, this.zLevel, textureSprite.getMaxU(),
				textureSprite.getMinV());
