...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
		...
		if (p_175272_1_ != null && p_175272_1_.getChatStyle().getChatHoverEvent() != null) {
			...
			if (var4.getAction() == HoverEvent.Action.SHOW_ITEM) {
				...
				if (var4.getAction() == HoverEvent.Action.SHOW_ENTITY) {
					...
					this.drawHoveringText(NEWLINE_SPLITTER.splitToList(var4.getValue().getFormattedText()), p_175272_2_,
							p_175272_3_);
	 ...
	 * 
	 * @param newChatText
	 *            The new chat text to be set
	 * @param shouldOverwrite
	 *            Determines if the text currently in the chat should be
