...
import nl.x.api.event.impl.EventTeleport;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
		...
		if (packetIn.getType() == 10) {
			...
			var8 = new EntityLargeFireball(this.clientWorldController, var2, var4, var6, packetIn.getSpeedX() / 8000.0D,
					packetIn.getSpeedY() / 8000.0D, packetIn.getSpeedZ() / 8000.0D);
			packetIn.func_149002_g(0);
		} else if (packetIn.getType() == 64) {
			var8 = new EntitySmallFireball(this.clientWorldController, var2, var4, var6, packetIn.getSpeedX() / 8000.0D,
					packetIn.getSpeedY() / 8000.0D, packetIn.getSpeedZ() / 8000.0D);
			packetIn.func_149002_g(0);
		} else if (packetIn.getType() == 66) {
			var8 = new EntityWitherSkull(this.clientWorldController, var2, var4, var6, packetIn.getSpeedX() / 8000.0D,
					packetIn.getSpeedY() / 8000.0D, packetIn.getSpeedZ() / 8000.0D);
			packetIn.func_149002_g(0);
		...
		if (var8 != null) {
			...
			if (packetIn.func_149009_m() > 0) {
				...
				((Entity) var8).setVelocity(packetIn.getSpeedX() / 8000.0D, packetIn.getSpeedY() / 8000.0D,
	...
	public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		EntityXPOrb var2 = new EntityXPOrb(this.clientWorldController, packetIn.getX(), packetIn.getY(),
				packetIn.getZ(), packetIn.getXPValue());
	...
	public void handleSpawnPainting(S10PacketSpawnPainting packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		EntityPainting var2 = new EntityPainting(this.clientWorldController, packetIn.getPosition(),
	...
	public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
		...
		if (java.util.Objects.isNull(var2))
			return;
		EventVelocity event = new EventVelocity(packetIn.getMotionX(), packetIn.getMotionY(), packetIn.getMotionZ());
		event.fire();
		if (event.isCanceled())
			return;
		var2.setVelocity(event.getX() / 8000.0D, event.getY() / 8000.0D, event.getZ() / 8000.0D);
	}
	...
	public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
		...
		var10.prevPosX = var10.lastTickPosX = var10.serverPosX = packetIn.getX();
		var10.prevPosY = var10.lastTickPosY = var10.serverPosY = packetIn.getY();
		var10.prevPosZ = var10.lastTickPosZ = var10.serverPosZ = packetIn.getZ();
		...
		EventSpawnPlayer pre = new EventSpawnPlayer(packetIn, var2, var4, var6, State.pre, var10);
		pre.fire();
		if (pre.isCanceled())
			return;
		this.clientWorldController.addEntityToWorld(packetIn.getEntityID(), var10);
		new EventSpawnPlayer(packetIn, var2, var4, var6, State.post, var10).fire();
	...
	public void handleEntityHeadLook(S19PacketEntityHeadLook packetIn) {
		...
		if (var2 != null) {
			float var3 = packetIn.getYaw() * 360 / 256.0F;
	...
	public void addToSendQueue(Packet p_147297_1_) {
		EventPacket event = new EventPacket(Type.outbound, p_147297_1_);
		event.fire();
		if (!event.isCanceled()) {
	...
	public void handleSpawnMob(S0FPacketSpawnMob packetIn) {
		...
		float var8 = packetIn.getYaw() * 360 / 256.0F;
		float var9 = packetIn.getPitch() * 360 / 256.0F;
		EntityLivingBase var10 = (EntityLivingBase) EntityList.createEntityByID(packetIn.getEntityType(),
	...
	public void handleExplosion(S27PacketExplosion packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		Explosion var2 = new Explosion(this.gameController.theWorld, (Entity) null, packetIn.getX(), packetIn.getY(),
	...
	public void handleOpenWindow(S2DPacketOpenWindow packetIn) {
		...
		if ("minecraft:container".equals(packetIn.getGuiId())) {
			...
			ContainerLocalMenu var4 = new ContainerLocalMenu(packetIn.getGuiId(), packetIn.getWindowTitle(),
	...
	public void handleStatistics(S37PacketStatistics packetIn) {
		...
		for (Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3
				.hasNext(); this.gameController.thePlayer.getStatFileWriter()
						.unlockAchievement(this.gameController.thePlayer, var5, var6)) {
	...
	public void handleEntityEffect(S1DPacketEntityEffect packetIn) {
		...
		if (var2 instanceof EntityLivingBase) {
			PotionEffect var3 = new PotionEffect(packetIn.getEffectId(), packetIn.getDuration(),
	...
	public void handleResourcePack(S48PacketResourcePackSend packetIn) {
		...
		if (var2.startsWith("level://")) {
			...
			if (var6.isFile()) {
				...
				Futures.addCallback(this.gameController.getResourcePackRepository().setResourcePackInstance(var6),
						new FutureCallback() {
							@Override
			...
			if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData()
				...
				this.netManager
						.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.ACCEPTED));
				Futures.addCallback(this.gameController.getResourcePackRepository().downloadResourcePack(var2, var3),
						new FutureCallback() {
							@Override
							public void onSuccess(Object p_onSuccess_1_) {
								NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(var3,
							...
							public void confirmClicked(boolean result, int id) {
								...
								if (result) {
									...
									Futures.addCallback(NetHandlerPlayClient.this.gameController
											.getResourcePackRepository().downloadResourcePack(var2, var3),
											new FutureCallback() {
												@Override
												public void onSuccess(Object p_onSuccess_1_) {
		...
		if (packetIn.getParticleCount() == 0) {
			...
			try {
				this.clientWorldController.spawnParticle(packetIn.getParticleType(), packetIn.isLongDistance(),
						packetIn.getXCoordinate(), packetIn.getYCoordinate(), packetIn.getZCoordinate(), var2, var4,
						var6, packetIn.getParticleArgs());
			...
			for (int var18 = 0; var18 < packetIn.getParticleCount(); ++var18) {
				...
				try {
					this.clientWorldController.spawnParticle(packetIn.getParticleType(), packetIn.isLongDistance(),
							packetIn.getXCoordinate() + var3, packetIn.getYCoordinate() + var5,
							packetIn.getZCoordinate() + var7, var9, var11, var13, packetIn.getParticleArgs());
