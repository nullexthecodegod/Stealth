...
public class Block {
	...
	public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos) {
		...
		return var4 < 0.0F ? 0.0F
				: (!playerIn.canHarvestBlock(this) ? playerIn.getToolDigEfficiency(this) / var4 / 100.0F
						: playerIn.getToolDigEfficiency(this) / var4 / 30.0F);
	}
	...
	/**
	 * Used by pick block on the client to get a block's item form, if it
	 * exists.
	 */
	...
	public static void registerBlocks() {
		...
		registerBlock(109, "stone_brick_stairs",
				(new BlockStairs(
						var8.getDefaultState().withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.DEFAULT)))
		...
		registerBlock(128, "sandstone_stairs",
				(new BlockStairs(
						var2.getDefaultState().withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.SMOOTH)))
		...
		registerBlock(156, "quartz_stairs",
				(new BlockStairs(
						var11.getDefaultState().withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.DEFAULT)))
		...
		registerBlock(164, "dark_oak_stairs",
				(new BlockStairs(
						var1.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK)))
